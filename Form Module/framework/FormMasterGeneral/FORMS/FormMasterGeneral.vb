Public Class FormMasterGeneral
    ...
    Private Sub FormMasterGeneral_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            stSQL = "SELECT kategori,locked FROM " & CONN_.schemaKomisi & ".msgeneralcategorylist WHERE locked='False' ORDER BY kategori;"
            ...
            stSQL = "SELECT kategori,locked FROM " & CONN_.schemaKomisi & ".msgeneralcategorylist ORDER BY kategori;"
            ...
            tableName(0) = CONN_.schemaKomisi & ".msgeneral"
            tableName(1) = CONN_.schemaKomisi & ".msgeneralcategorylist"
    ...
    Private Sub SetDGV(myConn As Object, myComm As Object, myReader As Object, offSet As Integer, ByRef myDataTable As DataTable, ByRef myBindingTable As BindingSource, mKriteria As String, Optional gantiKriteria As Boolean = False, Optional sortingCols As String = Nothing, Optional sortingType As String = Nothing)
        Try
            ...
            stSQL = "SELECT rid,kategori,keterangan,kode,locked,created_at,updated_at " &
                    "FROM ( " &
            ...
            With dgvView
                ...
                .Columns("kategori").Width = 100
                .Columns("keterangan").Width = 200
                .Columns("kode").Width = 70
                .Columns("locked").Width = 60
        ...
        Try
            If (Trim(tbPathSimpan.Text).Length > 0 And Trim(tbNamaSimpan.Text).Length > 0) Then
                If (cboCariKategori.SelectedIndex <> -1) Then
                    ...
                    stSQL = "SELECT kategori,kode,keterangan,faktorqty FROM " & CONN_.schemaKomisi & ".msgeneral WHERE kategori='" & myCStringManipulation.SafeSqlLiteral(cboCariKategori.SelectedValue) & "' GROUP BY kategori,kode,keterangan,faktorqty ORDER BY keterangan;"
