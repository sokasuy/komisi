Public Class CStartup
    ...
    Public Sub StartUp(ByVal _segmen As String, ByRef _companyName As String, ByRef _programName As String, ByRef _programType As String, ByRef _connMain As Object, ByRef _connSQL As Object, ByRef _dbType As String, ByRef _schemaTmp As String, ByRef _schemaKomisi As String)
        Try
            If (_segmen = "MAIN") Then
                ...
                'UNTUK DATABASE SRF SQL SERVER
                Call myCDBConnection.SetDBParameter(_connSQL, "SQLSrv", "SERVER_NAME", "DB_NAME_SRF", "", pathFileSetting, "PORT", "sa", "admin", "")
